...
_REGION_TO_ACCENT: dict[str, str] = {
    # Chinese
    "中国大陆": "mainland", "mainland": "mainland", "mainland_urban": "mainland",
    "北京": "mainland", "上海": "mainland",
    ...
    # Japanese
    "東京": "tokyo", "tokyo": "tokyo", "大阪": "osaka", "osaka": "osaka",
    # Korean
    "서울": "seoul", "seoul": "seoul", "수도권": "seoul",
    "부산": "busan", "busan": "busan",
    # Arabic
    "dubai": "gulf", "abu_dhabi": "gulf", "doha": "gulf",
    "riyadh": "gulf", "jeddah": "gulf", "gulf": "gulf",
    "cairo": "egyptian", "alexandria": "egyptian",
    "beirut": "levantine", "amman": "levantine", "levantine": "levantine",
    # Hindi
    "delhi": "delhi", "mumbai": "mumbai", "bangalore": "bangalore",
    "kolkata": "kolkata", "hyderabad": "hyderabad",
    # Thai
    "bangkok": "bangkok", "กรุงเทพ": "bangkok",
    "chiang_mai": "chiang_mai", "เชียงใหม่": "chiang_mai",
    # Italian
    "milan": "milan", "milano": "milan",
    "rome": "rome", "roma": "rome",
    "turin": "milan", "torino": "milan",
    "florence": "rome", "firenze": "rome",
    "naples": "rome", "napoli": "rome",
    # Russian
    "moscow": "moscow", "москва": "moscow",
    "spb": "spb", "saint_petersburg": "spb", "санкт-петербург": "spb",
    "novosibirsk": "moscow", "kazan": "moscow",
    # Turkish
    ...
    "montreal": "quebec", "québec": "quebec",
    # Spanish
    "mexico_city": "mexican", "mexican": "mexican",
    "los_angeles": "chicano", "miami": "caribbean",
    "madrid": "castilian", "bogota": "colombian",
    # Malay
    "kuala_lumpur": "kl", "kl": "kl", "penang": "kl",
    # Hokkien
    "厦门": "xiamen", "泉州": "xiamen", "漳州": "xiamen",
    # Overseas (generic)
    "overseas": "overseas", "overseas_us": "american",
    "欧美": "american", "アメリカ": "american", "欧米": "american",
    "欧美/澳洲": "american", "欧米/豪州": "american",
}
